...
TRACKED_STATS: list[tuple[str, str]] = [
    ...
    ("Teamfight Healing Done", "TeamfightHealingDone"),
    ("Protection Given To Allies", "ProtectionGivenToAllies"),
    ...
    ("Time CC'd Enemy Heroes", "TimeCCdEnemyHeroes"),
    ...
    ("Teamfight Escapes Performed", "TeamfightEscapesPerformed"),
